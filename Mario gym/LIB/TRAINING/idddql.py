...
class IDDDQL:
    def __init__(self ,lambda_1=1.0,lambda_2=1.0,lambda_3=0.0,lambda_="l1"):
        print("Iota Dueling Double Deep Q-Learning mario environment training")
        pygame.init()
        pygame.display.set_caption("MEXITENDO")
        self.lambda_1=lambda_1
        self.lambda_2=lambda_2
        self.lambda_3=lambda_3
        self.experiment_name="idddql"+lambda_
        self.experiment_name_="idddql"
...
def save_data(data):
    with open(r''+ENV_PATH+'/tmp/idddql.yaml', 'w') as outfile:
        data={'avr_r':data}
        yaml.dump(data, outfile, default_flow_style=False)
