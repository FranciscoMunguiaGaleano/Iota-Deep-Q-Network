...
from game import TaxiGym_v1_0 as env
...
if __name__ == "__main__":
    #print("Training TaxiDriver environment with DQL")
    #env=DQL()
    #env.epoch_training()
    ...
    #pygame.quit()
    #print("Training TaxiDriver environment with DDQL")
    #env=DDQL()
    #env.epoch_training()
    #env.episode_training("ddqdl")
    #pygame.quit()
    #print("Training FlappyBirds envirnoment with DuDQL")
    #env=DuDQL()
    #env.epoch_training()
    #env.episode_training("dudqdl")
    #pygame.quit()
    #print("Training FlappyBirds environment with DDDQL")
    #env=DDDQL()
    #env.epoch_training()
    #env.episode_training("dddqdl")
    #pygame.quit()
    #print("Training TaxiDriver environment with IDQL")
    ...
    #env.epoch_training()
    #pygame.quit()
    #print("Training TaxiDriver environment with IDDQL")
    ...
    #env.epoch_training()
    #pygame.quit()
    print("Training TaxiDriver environment with IDuDQL")
    ...
    pygame.quit()
    print("Training TaxiDriver environment with IDDDQL")
