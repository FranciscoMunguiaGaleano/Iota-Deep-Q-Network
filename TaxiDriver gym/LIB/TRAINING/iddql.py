...
from game import TaxiGym_v1_0 as envi
from agents import *
...
class IDDQL:
    def __init__(self ,lambda_1=1.0,lambda_2=1.0,lambda_3=0.0,lambda_="l1"):
        print("Iota Double Deep Q-Learning FlappyBirds environment training")
        pygame.init()
...
if __name__ == "__main__":
    print("Training FlappyBirds environment with IDDQL")
