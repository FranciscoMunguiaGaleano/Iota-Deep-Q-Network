...
if __name__ == "__main__":
    #print("Training Pacman environment with DQL")
    #env=DQL()
    #env.epoch_training()
    #env.episode_training("random")
    #env.episode_training("qdl")
    #pygame.quit()
    #print("Training Pacman environment with DDQL")
    #env=DDQL()
    #env.epoch_training()
    #env.episode_training("ddqdl")
    #pygame.quit()
    #print("Training Pacman envirnoment with DuDQL")
    #env=DuDQL()
    #env.epoch_training()
    ...
    pygame.quit()
    print("Training Pacman environment with IDuDQL")
    ...
    pygame.quit()
    print("Training Pacman environment with IDDDQL")
