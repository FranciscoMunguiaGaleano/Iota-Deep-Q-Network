...
from game import Pacman_v1_1 as envi
from agents import *
...
class IDDQL:
    def __init__(self ,lambda_1=1.0,lambda_2=1.0,lambda_3=0.0,lambda_="l1"):
        print("Iota Double Deep Q-Learning Pacman environment training")
        pygame.init()
    ...
    def epoch_training(self):
        ...
        while epoch<self.max_epochs:
            ...
            while not d:
                ...
                if self.environment.global_done:
                    break
                if self.environment.global_done:
                    d=True 
...
if __name__ == "__main__":
    print("Training Pacman environment with IDDQL")
