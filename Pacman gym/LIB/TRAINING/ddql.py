...
class DDQL:
    def __init__(self):
        print("Double Deep Q-Learning FlappyBirds environment training")
        pygame.init()
        pygame.display.set_caption("Pacman")
        self.experiment_name="ddql"
        ...
        self.agente=SimpleQAgent(n_actions=self.n_actions,input_shape=s.flatten().shape,buffer_size=self.max_queue_length,batch_size=self.mini_batch_size)
...
if __name__ == "__main__":
    print("Training FlappyBirds environment with DDQL")
    env=DDQL()
    env.epoch_training()
