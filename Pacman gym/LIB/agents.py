...
class SimpleDuelingAgent():
      def __init__(self, gamma=0.99, replace=100, lr=0.001,n_actions=4,input_shape=[0,0,0,0],buffer_size= 50000,batch_size=64):
...
class IotaDuelingAgent():
      def __init__(self, gamma=0.99, replace=100, lr=0.001,n_actions=4,input_shape=[0,0,0,0],buffer_size= 50000,batch_size=64,lambda_1=1.0,lambda_2=0.0,lambda_3=0.0):
          self.buffer_size = buffer_size
          self.input_shape=input_shape
...
class SimpleQAgent():
      ...
      def train_double(self):
          ...
          return float(maxq.numpy()),float(loss.numpy())
class IotaQAgent():
      def __init__(self, gamma=0.99, replace=100, lr=0.001,n_actions=4,input_shape=[0,0,0,0],buffer_size= 50000,batch_size=64,lambda_1=1.0,lambda_2=0.0,lambda_3=0.0,bacth_size=64):
          self.buffer_size = buffer_size
